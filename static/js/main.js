...
function Authenticate(successCb, errorCb) {
  const pwdBox = document.querySelector('[role="password-field"]');
  ...
  const data = JSON.stringify({password: pwdBox.value});
  xhttp.send(data);
}
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document.querySelector('[role="login-btn"]').addEventListener('click', (ev) => {
